import{S as D,i as E,s as $,k as p,q as _,a as x,l as v,m as g,r as y,h as d,c as w,n as h,b as k,J as m,E as J,P as I,Q as A,D as b,G as H,N as j,R as W,o as Y,T as Q,U as B,e as L,V as X,W as Z,X as ee,w as T,x as z,y as S,f as G,t as P,z as V,u as U,Y as te}from"../../chunks/index-b5746da8.js";import{h as O,i as N,d as ne}from"../../chunks/stores-54d26941.js";function re(s){function t(r){r.key==="Enter"?s.dispatchEvent(new CustomEvent("enterkey")):r.key==="ArrowUp"?s.dispatchEvent(new CustomEvent("arrowup")):r.key==="ArrowDown"&&s.dispatchEvent(new CustomEvent("arrowdown"))}return document.addEventListener("keydown",t,!0),{destroy(){document.removeEventListener("keydown",t,!0)}}}function ie(s){let t,r,a,n,i,e,l;return{c(){t=p("form"),r=p("p"),a=_(F),n=x(),i=p("input"),this.h()},l(c){t=v(c,"FORM",{class:!0});var u=g(t);r=v(u,"P",{class:!0});var o=g(r);a=y(o,F),o.forEach(d),n=w(u),i=v(u,"INPUT",{class:!0,type:!0,placeholder:!0}),u.forEach(d),this.h()},h(){h(r,"class","w-6 h-6 text-green-500 dark:text-emerald-600 animate-pulse font-firacode"),h(i,"class","caret-pink-600 focus-visible:outline-none placeholder:text-slate-500 dark:placeholder:text-slate-600 bg-transparent text-sky-500 dark:text-cyan-500 crt-anim"),h(i,"type","text"),h(i,"placeholder","enter command here."),h(t,"class","flex")},m(c,u){k(c,t,u),m(t,r),m(r,a),m(t,n),m(t,i),s[5](i),e||(l=[J(re.call(null,i)),I(i,"arrowup",A(s[2])),I(i,"arrowdown",A(s[3])),I(t,"submit",A(s[1]))],e=!0)},p:b,i:b,o:b,d(c){c&&d(t),s[5](null),e=!1,H(l)}}}let F="\uF054";function ae(s,t,r){let a;j(s,O,f=>r(6,a=f));const n=W();let{hindex:i=a.length}=t,e;function l(){e.value&&(n("submit",e.value),B(O,a[a.length]=e.value,a),r(4,i=a.length),r(0,e.value="",e)),e.focus()}Y(()=>{e.focus()});function c(){i!=0&&(r(4,i--,i),r(0,e.value=a[i],e))}function u(){i<a.length-1?(r(4,i++,i),r(0,e.value=a[i],e)):(r(4,i=a.length),r(0,e.value="",e))}function o(f){Q[f?"unshift":"push"](()=>{e=f,r(0,e)})}return s.$$set=f=>{"hindex"in f&&r(4,i=f.hindex)},[e,l,c,u,i,o]}class se extends D{constructor(t){super(),E(this,t,ae,ie,$,{hindex:4})}}function le(s){switch(s.toLowerCase().trim()){default:return"<div class='text-red-600'>command '"+s+"' not found.</div>";case"contact":return me();case"help":return de();case"about":return fe();case"ls":return ue();case"src":return ce();case"sensi":return oe();case"project":return he()}}function oe(){return window.open("https://github.com/GazDuckington/sensi","_blank"),`
		<div>
			<a
